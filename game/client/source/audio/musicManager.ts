...
const SFX_SOURCES: Record<SfxId, string> = {
  ...
  sword: '/audio/sfx/weapons/sword.flac',
  levelup: '/audio/sfx/player/levelup.mp3',
  hit: '/audio/sfx/enemies/hit.mp3',
  fall: '/audio/sfx/player/fall.mp3',
  raygun: '/audio/sfx/weapons/raygun.wav',
  gun: '/audio/sfx/weapons/gun.wav',
...
function fadeToSfxAudibleTarget(track: Track, durationMs: number): void {
  const target = settings.sfxMuted || !track.shouldPlay ? 0 : track.targetVolume;
...
export function playSfx(id: SfxId, volume = SFX_VOLUME): void {
