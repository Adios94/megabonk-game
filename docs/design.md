...
敌人死亡时，`enemy.xpReward` 会直接写入 XP pickup 的 `value`，颜色只用于视觉分档。Boss 死亡额外掉落一个 `value = 100` 的橙色 XP pickup。
...
| Lv | 伤害 | CD | 弹数 | 范围 | AoE | 速度 |
|---|---|---|---|---|---|---|
| 1 | 16 | 0.80 | 1 | 3.0 | 3.0 | 10 |
| 2 | 20 | 0.80 | 1 | 3.7 | 3.4 | 11 |
| 3 | 23 | 0.70 | 1 | 4.4 | 3.8 | 12 |
| 4 | 29 | 0.70 | 1 | 5.1 | 4.2 | 14 |
| 5 | 34 | 0.60 | 1 | 5.8 | 4.6 | 15 |
| 6 | 39 | 0.60 | **2** | 6.5 | 5.0 | 17 |
| 7 | 46 | 0.50 | 2 | 7.2 | 5.5 | 18 |
| 8 | 55 | 0.50 | **3** | 8.0 | 6.0 | 20 |
...
| 4 | 16 | 1.30 | 2 | 3.5 | 1.0 | 4.5 |
| 5 | 18 | 1.20 | **3** | 4.0 | 1.0 | 5.0 |
| 6 | 20 | 1.10 | 3 | 4.0 | 1.0 | 5.0 |
| 7 | 22 | 1.00 | 3 | 4.5 | 1.0 | 5.5 |
| 8 | 24 | 0.90 | 3 | 5.0 | 1.0 | 6.0 |
...
| Lv | 伤害 | CD | 索敌范围 | 射线宽度 | 穿透 |
|---|---|---|---|---|---|
| 1 | 6 | 1.50 | 8 | 0.50 | 999 |
| 2 | 9 | 1.40 | 10 | 0.52 | 999 |
| 3 | 12 | 1.30 | 12 | 0.54 | 999 |
| 4 | 15 | 1.20 | 14 | 0.55 | 999 |
| 5 | 18 | 1.10 | 15 | 0.56 | 999 |
| 6 | 21 | 1.00 | 16 | 0.58 | 999 |
| 7 | 24 | 0.95 | 17 | 0.59 | 999 |
| 8 | 26 | 0.90 | 18 | 0.60 | 999 |

#### ☁️ Poison Bomb 毒气弹

| Lv | DPS | CD | 毒云数 | 投掷范围 | 云半径 |
|---|---|---|---|---|---|
| 1 | 6 | 2.00 | 1 | 10 | 3.0 |
| 2 | 8 | 1.90 | 1 | 12 | 3.0 |
| 3 | 11 | 1.80 | 1 | 14 | 3.3 |
...
|---|---|---|---|---|---|
| sword | attack_speed_tome | 5 | 死刑执行者 | ×2.5 | dmg 138、CD 0.5、4 弧、范围 8.0 / AoE 6.0 |
| axe | knockback_tome | 3 | 狂战士之斧 | ×2.0 | dmg 48、CD 0.9、4 把、半径 5.0 |
| bone_bouncer | luck_tome | 3 | 骨暴风 | ×2.0 | dmg 60、CD 0.6、4 弹、6 弹射 |
| bow | precision_tome | 3 | 沙漠之鹰 | ×3.0 | dmg 174、CD 0.8、4 弹、4 穿透 |
| lightning_staff | curse_tome | 3 | 雷神 | ×2.5 | dmg 88、CD 0.6、9 链、范围 40 |
...
```
基础 = pickup.value（普通怪来自 enemy.xpReward；Boss 固定 100）
